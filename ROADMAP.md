...
**Статус: In progress — SSH identity migration v1**

Первый вертикальный сценарий SSH identity migration реализован отдельной
командой; остальные категории защищённого переноса остаются возможными
