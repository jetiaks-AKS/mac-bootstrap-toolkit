...
## Этап 14 — Discovery & Restore Reporting
...
## Этап 16 — Environment Comparison / Profiles
...
Дополнительные области macOS, включая Energy / `pmset` и Login Items, плагины
и GUI требуют отдельной оценки ценности и безопасности; они не входят в
