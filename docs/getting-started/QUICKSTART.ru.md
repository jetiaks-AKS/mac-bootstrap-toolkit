...
Это руководство описывает реализованный workflow стабильной версии 2.0.1:
...
Blueprint не входит в стабильную версию 2.0.1; он реализован и E2E-проверен в
ветке `develop`, но ещё не выпущен. Dry-run и Verification запланированы и пока
не реализованы. В частности, опция `--dry-run` текущим CLI не поддерживается.
